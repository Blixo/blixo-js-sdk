  ...
  const sdk = {
    ...
    customer: {
      ...
      get: async () => {
        ...
        // from page context
        else if(!sdk.customer.data && _.get(window, 'blixoPageContext.customer.id')) {
          const customerData = _.get(window, 'blixoPageContext.customer');
          sdk.customer.data = customerData;
        }
    ...
    paymentMethods: PaymentMethods(configs),
